				...
				{newProducts.map((product) => (
					<div
						...
						<div className='relative aspect-square'>
							...
							{/* Badge */}
							<span className={`absolute top-2 left-2 h-6 min-w-11.25 px-2.5 flex items-center justify-center rounded-full text-xs text-white font-normal ${product.badgeType === "new" ? "bg-[#1a73e8]" : "bg-red-600"}`}>
								{product.badge}
							</span>
